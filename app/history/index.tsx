    ...
    <View className="flex-1 bg-silver-white" style={{ paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0 }}>
      ...
      <ScrollView className="flex-1 p-4" contentContainerStyle={{ paddingBottom: 100 }}>
            ...
            <View className="relative w-full">
              ...
              <View className="flex-row items-center bg-silver-white border-[3px] border-slate-900 px-3 h-12">
                ...
                <TextInput 
                  ...
                  className="flex-1 ml-3 font-outfit font-bold text-sm tracking-widest uppercase text-slate-900"
                />
              </View>
            </View>
          </View>
        ...
        <View className="flex-row items-center gap-3 mb-8 px-1">
          <View className="relative">
             <View className="absolute top-1 left-1 w-full h-full bg-slate-900" />
             <Pressable className="bg-silver-white border-[3px] border-slate-900 px-4 py-1.5 active:translate-x-1 active:translate-y-1">
               <Text className="font-bold text-xs uppercase tracking-widest text-slate-900">ALL</Text>
             </Pressable>
          </View>
          <View className="relative">
             <View className="absolute top-1 left-1 w-full h-full bg-slate-900" />
             <Pressable className="bg-silver-white border-[3px] border-slate-900 px-4 py-1.5 active:translate-x-1 active:translate-y-1">
               <Text className="font-bold text-xs uppercase tracking-widest text-slate-900">TODAY</Text>
             </Pressable>
          </View>
          <View className="relative">
             <View className="absolute top-1 left-1 w-full h-full bg-slate-900" />
             <Pressable className="bg-biru-muda border-[3px] border-slate-900 px-4 py-1.5 active:translate-x-1 active:translate-y-1">
               <Text className="font-bold text-xs uppercase tracking-widest text-slate-900">THIS WEEK</Text>
             </Pressable>
          </View>
        </View>
        ...
        <View className="gap-6 px-1">
            ...
            <View className="bg-silver-white border-[3px] border-slate-900 p-3 flex-row items-center gap-4">
              ...
              <View className="flex-1 justify-center py-1">
                 <View className="flex-row justify-between items-center mb-1">
                    <Text className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">MAY 19, 2026</Text>
                    <ChevronRight size={16} color="#0f172a" />
                 </View>
                 <Text className="font-outfit text-3xl font-black text-slate-900 tracking-tighter leading-none mb-1">9.32 <Text className="text-sm">KM</Text></Text>
                 <View className="flex-row justify-between items-end mt-1">
                    ...
                    <View className="relative">
                       ...
                       <View className="bg-biru-muda border-2 border-slate-900 px-2 py-0.5">
                          <Text className="text-[10px] font-black text-slate-900 uppercase tracking-widest">180 XP</Text>
                       </View>
                    </View>
                 </View>
              </View>
          ...
          <View className="relative w-full">
            ...
            <View className="bg-silver-white border-[3px] border-slate-900 p-3 flex-row items-center gap-4">
              ...
              <View className="flex-1 justify-center py-1">
                 <View className="flex-row justify-between items-center mb-1">
                    <Text className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">MAY 17, 2026</Text>
                    <ChevronRight size={16} color="#0f172a" />
                 </View>
                 <Text className="font-outfit text-3xl font-black text-slate-900 tracking-tighter leading-none mb-1">12.05 <Text className="text-sm">KM</Text></Text>
                 <View className="flex-row justify-between items-end mt-1">
                    <Text className="text-xs font-bold text-slate-600 tracking-widest">⏱ 01:22:15</Text>
                    {/* XP Badge */}
                    <View className="relative">
                       <View className="absolute top-[2px] left-[2px] w-full h-full bg-slate-900" />
                       <View className="bg-biru-muda border-2 border-slate-900 px-2 py-0.5">
                          <Text className="text-[10px] font-black text-slate-900 uppercase tracking-widest">250 XP</Text>
                       </View>
                    </View>
                 </View>
              </View>
          ...
          <View className="relative w-full">
            ...
            <View className="bg-silver-white border-[3px] border-slate-900 p-3 flex-row items-center gap-4">
              ...
              <View className="flex-1 justify-center py-1">
                 <View className="flex-row justify-between items-center mb-1">
                    <Text className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">MAY 15, 2026</Text>
                    <ChevronRight size={16} color="#0f172a" />
                 </View>
                 <Text className="font-outfit text-3xl font-black text-slate-900 tracking-tighter leading-none mb-1">5.10 <Text className="text-sm">KM</Text></Text>
                 <View className="flex-row justify-between items-end mt-1">
                    <Text className="text-xs font-bold text-slate-600 tracking-widest">⏱ 00:34:50</Text>
                    {/* XP Badge */}
                    <View className="relative">
                       <View className="absolute top-[2px] left-[2px] w-full h-full bg-slate-900" />
                       <View className="bg-biru-muda border-2 border-slate-900 px-2 py-0.5">
                          <Text className="text-[10px] font-black text-slate-900 uppercase tracking-widest">85 XP</Text>
                       </View>
                    </View>
                 </View>
              </View>
